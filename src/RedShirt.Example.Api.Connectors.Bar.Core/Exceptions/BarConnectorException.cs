namespace RedShirt.Example.Api.Connectors.Bar.Core.Exceptions;
...
/// </summary>
public sealed class BarConnectorException : Exception
{
    /// <summary>
    ...
    public BarConnectorException(Exception innerException) : base(innerException.Message, innerException)
    {
    }

    public BarConnectorException(string message) : base(message)
    {
    }
}