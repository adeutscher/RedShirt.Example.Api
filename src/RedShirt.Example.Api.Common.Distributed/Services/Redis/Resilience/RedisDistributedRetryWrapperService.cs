...
namespace RedShirt.Example.Api.Common.Distributed.Services.Redis.Resilience;
    ...
    : IDistributedRetryWrapperService
{
    ...
    ///     If wrapping was appropriate, then will be <see cref="ApiDistributedException" /> wrapped around the
    ...
    private bool TryGetWrappedException(Exception exception, out Exception? wrappedException)
    {
        ...
        wrappedException = new ApiDistributedException(exception)
        {
