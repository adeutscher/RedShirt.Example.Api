...
namespace RedShirt.Example.Api.Common.Aws.SsmSecretManager.Services.Resilience;
    ...
    : ISsmRetryWrapperService
{
    ...
    ///     If wrapping was appropriate, then will be <see cref="ApiSecretManagerException" /> wrapped around the
    ...
    private bool TryGetWrappedException(Exception exception, out Exception? wrappedException)
    {
        ...
        wrappedException = new ApiSecretManagerException(exception)
        {
