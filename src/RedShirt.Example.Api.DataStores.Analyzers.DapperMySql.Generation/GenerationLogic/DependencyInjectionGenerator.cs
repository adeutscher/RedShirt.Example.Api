...
public static class DependencyInjectionGenerator
{
        ...
        ClassSummaryModel classSummaryModel)
    {
        ...
        sb
            ...
            .AppendLineWithIndent(2,
                $"serviceCollection = {classSummaryModel.BaseNamespace}.DataStores.Common.DapperMySql.Extensions.ServiceCollectionExtensions.AddGenericMysqlDtoHandler<{classSummaryModel.FullEntityName}, {classSummaryModel.Key.Type}>(serviceCollection);")
