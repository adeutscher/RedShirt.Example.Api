...
using RedShirt.Example.Api.Common.Distributed.Services.Redis.Resilience;
using RedShirt.Example.Api.Common.SecretManagers.Core.Exceptions;
using StackExchange.Redis;
using System.Net.Sockets;

namespace RedShirt.Example.Api.Common.Distributed.UnitTests.Tests.Services.Redis.Resilience;
...
public class RedisDistributedExceptionArbiterServiceTests
{
    ...
    {
#pragma warning disable SER007 // RedisErrorKind is experimental; needed to construct RedisServerException
