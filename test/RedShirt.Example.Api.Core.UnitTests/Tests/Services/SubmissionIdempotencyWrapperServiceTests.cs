...
/// </summary>
public class SubmissionIdempotencyWrapperServiceTests
{
    [Fact]
    public async Task RunIdempotentlyAsync_ReturnsCachedResponse_WithoutLockOrCallback()
    {
        ...
        var service = new SubmissionIdempotencyWrapperService(idempotency.Object);
    ...
    [Fact]
    public async Task RunIdempotentlyAsync_DoesNotCacheOrUnlock_WhenCallbackThrows()
    {
        var lockHandle = CreateLock(true);
        var idempotency = new Mock<ISubmissionIdempotencyService>();
        idempotency
