...
# To rotate a secret WireMock will also accept: ./bar-rotate-oauth-credentials.sh [new-secret] [new-token]
#
# Usage:
#   ./bar-set-ssm-oauth-secret.sh [secret]
#
# Examples:
#   ./bar-set-ssm-oauth-secret.sh
