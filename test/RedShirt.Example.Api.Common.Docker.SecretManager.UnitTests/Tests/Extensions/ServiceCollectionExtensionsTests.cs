...
using RedShirt.Example.Api.Common.Docker.SecretManager.Extensions;
...
namespace RedShirt.Example.Api.Common.Docker.SecretManager.UnitTests.Tests.Extensions;
